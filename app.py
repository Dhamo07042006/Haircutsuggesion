...
# st.title("Face Shape & Hairstyle Demo (Webcam or Upload)")
...
#     "Square": ["Curly Taper Fade", "medium length classic side part", "Undercut Quiff"],
#     "Heart": ["Low Fade Pompadour", " french crop with a fade", "Short Straight Dark Mocha Brunette"]
# }
